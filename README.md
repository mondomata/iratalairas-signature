...
☝️A megoldás nem csak online tárhelyek segítségével és/vagy nem csak a Google vagy a Microsoft online és offline szövegszerkesztő programjaival működik. Pl. Linux rendszereken elterjedt (és Windowson is használható, ingyenes!) LibreOffice irodai csomag szövegszerkesztő (Libreoffice Writer) tökéletesen alkalmas szerkesztésre (doc, docx is) és aláíráskép beillesztésre a fentiekkel azonos módon, az "aláírt" iratot ez esetben PDF-be nyomtatás menüponttal lehet a Writer-ből pdf-be menteni és felhasználni...
